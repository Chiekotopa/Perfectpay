...
public class BalanceRequestMobile extends com.payment.pay.gtplimited.BalanceRequest
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BalanceRequestMobile".equals(type)) {
                            ...
                            return (BalanceRequestMobile) com.payment.pay.gtplimited.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
