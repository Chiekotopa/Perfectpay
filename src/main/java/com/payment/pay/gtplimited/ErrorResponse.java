...
public class ErrorResponse extends com.payment.pay.gtplimited.BaseResponseBody
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ErrorResponse".equals(type)) {
                            ...
                            return (ErrorResponse) com.payment.pay.gtplimited.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
