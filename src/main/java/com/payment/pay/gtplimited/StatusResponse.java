...
public class StatusResponse extends com.payment.pay.gtplimited.BaseResponseBody
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"StatusResponse".equals(type)) {
                            ...
                            return (StatusResponse) com.payment.pay.gtplimited.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
