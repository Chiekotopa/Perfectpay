...
public class ReactivateCardRequest extends com.payment.pay.gtplimited.BaseRequestBody
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReactivateCardRequest".equals(type)) {
                            ...
                            return (ReactivateCardRequest) com.payment.pay.gtplimited.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
