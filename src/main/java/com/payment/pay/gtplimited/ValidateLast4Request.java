...
public class ValidateLast4Request extends com.payment.pay.gtplimited.BaseRequestBody
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ValidateLast4Request".equals(type)) {
                            ...
                            return (ValidateLast4Request) com.payment.pay.gtplimited.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
