...
public class GetCardInfoRequest extends com.payment.pay.gtplimited.BaseRequestBody
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetCardInfoRequest".equals(type)) {
                            ...
                            return (GetCardInfoRequest) com.payment.pay.gtplimited.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
