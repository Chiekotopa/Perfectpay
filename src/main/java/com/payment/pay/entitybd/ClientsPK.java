...
public class ClientsPK implements Serializable {
    ...
    public ClientsPK(int nEng, String indexe) {
        this.nEng = nEng;
        this.indexe = indexe;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ClientsPK)) {
            return false;
        }
        ClientsPK other = (ClientsPK) object;
    ...
    public String toString() {
        return "com.payment.pay.entitybd.ClientsPK[ nEng=" + nEng + ", indexe=" + indexe + " ]";
    }
