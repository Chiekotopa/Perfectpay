 ...
 */
@Embeddable
public class SouscriptionsPK implements Serializable {
    ...
    public SouscriptionsPK() {
    }

    public SouscriptionsPK(int nEng, String indexe) {
        this.nEng = nEng;
        this.indexe = indexe;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SouscriptionsPK)) {
            return false;
        }
        SouscriptionsPK other = (SouscriptionsPK) object;
    ...
    public String toString() {
        return "com.payment.pay.entitybd.SouscriptionsPK[ nEng=" + nEng + ", indexe=" + indexe + " ]";
    }
