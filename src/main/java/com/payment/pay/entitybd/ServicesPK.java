...
public class ServicesPK implements Serializable {
    ...
    public ServicesPK(int nEng, String indexe) {
        this.nEng = nEng;
        this.indexe = indexe;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ServicesPK)) {
            return false;
        }
        ServicesPK other = (ServicesPK) object;
    ...
    public String toString() {
        return "com.payment.pay.entitybd.ServicesPK[ nEng=" + nEng + ", indexe=" + indexe + " ]";
    }
